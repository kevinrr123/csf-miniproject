...
public class RecipeRESTController {
    ...
    @PostMapping(path="/deleteFav/{id}")
    public void delRecipes(HttpSession sess,@PathVariable(value="id") String id,            
        HttpServletResponse response) throws IOException {
        
        String username = sess.getAttribute("name").toString();
        recipeSvc.delRecipe(username, id);
        response.sendRedirect("redirect:/favs");
    }
